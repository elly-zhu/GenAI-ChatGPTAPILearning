...
#   cases, it can be beneficial to first classify
#   the type of query, and then use that
#   classification to determine which instructions
#   to use.
# - This can be achieved by defining fixed
#   categories and hard-coding instructions that are
#   relevant for handling tasks in a given category.
#######################################################
